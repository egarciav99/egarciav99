...
Antes coordiné obra eléctrica en un data center de Microsoft y en una nave de BMW Group. De ahí viene mi forma de trabajar: requisitos claros, procesos medibles y supervisión humana en los puntos críticos, también cuando hay IA de por medio.

🌐 [Web personal](https://egarciav99.github.io) · 💼 [LinkedIn](https://www.linkedin.com/in/eliergv/) · 🏢 [EG Solutions](https://www.egsolutions.tech)
...
**Backend y datos:** Supabase (Postgres, RLS, pgvector, Edge Functions) · Firebase / Firestore · Python (FastAPI, Pandas) · Vercel
**IA y automatización:** Gemini · Azure OpenAI · RAG · n8n · ExcelJS
**Calidad:** Vitest · Playwright · Sentry

## Formación

- Máster en Business Analytics & IA, INESDI (UNIE), 2026: mejor expediente de la promoción
- Grado en Ingeniería Eléctrica, TecNM Chihuahua

📫 Busco nuevos proyectos y también empleo en España. Escríbeme por [LinkedIn](https://www.linkedin.com/in/eliergv/) o desde el [formulario de EG Solutions](https://www.egsolutions.tech/contacto).
